...
data_exp <- get(load("thyroid/data/THCA_dataFilt_HUGO.rda"))

# Load methylation data
data_met <- get(load("thyroid/data/THCA_DNAMet.rda"))
...
save(data_exp_subsetted,
     file = "thyroid/data/THCA_dataFilt_wrangled.rda")

# Save wrangled methylation data
save(data_met_subsetted, 
     file = "thyroid/data/THCA_dataMet_wrangled.rda")

# Save sample annotations
save(sample_annotation,
     file = "thyroid/data/THCA_sample_annotations.rda")
